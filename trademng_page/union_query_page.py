...
class UnionQuery(BasePage):
    ...
    def __init__(self):
        ...
        # 查询定义
        self.loc_defineId_select = (By.ID, "defineId")
        # 订单提交时间-开始时间
        self.loc_startTime_input = ("id", "startTime")
        # 订单提交时间-结束时间
        self.loc_endTime_input = ("id", "endTime")
        # 订单号类型
        self.loc_orderType_select = (By.ID, "orderType")
        # 订单号
        self.loc_orderNo_input = (By.ID, "partnerId")
        # 查询
        self.loc_query_btn = (By.ID, "btn-query")
        # 重置
        self.loc_reset_btn = (By.ID, "btn-reset")
        # 查询有结果
